...
const MainContainer = (props) => {
    return (
        <div className={` laptop:absolute laptop:top-16 box-border mobile:px-4 mobile:py-10 laptop:p-10 ${props.showSidebar ? ' laptop:left-[30%] desktop:left-[20%] laptop:w-[70%] desktop:w-[80%]' : ' laptop:left-0 w-[100%]'}`}>
            <Routes>
